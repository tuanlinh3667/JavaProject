...
public class ChatClient extends Application {
    ...
    private final String imageUrl2 = "https://orig00.deviantart.net/3cd1/f/2012/364/8/d/astronaut_teemo_by_fazie69-d5pojc9.png";
    ...
    class ChatClientReaderThread extends Thread {
        ...
        public void run() {
          int DELAY = 1000/60;
            ...
            timer.schedule(new fuckPerformance(), 0, DELAY);

        }
        public class fuckPerformance extends java.util.TimerTask {
            public void run() {
                try {
